...
const differentTexts = [
  ...
  },
  {
    ...
    title: "Lab Of Mayhem",
    text: "The lab was heated. All one could hear was the intense chaos going on around. In every person’s eardrums could be heard the many sounds that filled the room. The “SHEEEE” of the water, the “CLACK, CLACK,” of test tubes hitting the side of the funnels, and most importantly the concerned chatter of each person disputing with their lab partners. In fact, the stress of each person was so great that one would think that every person had inhaled some helium due to the high pitched concerned of everyone’s voices. The metallic scent of the copper had filled the room, and every person was conscience of the danger around every corner.  One wrong move and one would knock over a test tube with dangerous chemicals. While all this is going on, one needs to be precise with amount of chemicals they are putting in. A small misjudgment and one would have to restart the whole process.  “5 minutes left!!”, and with that simple message, the room exploded in to utter mayhem. Screams could be heard from far away, screams screaming at their lab partner to speed up. “AHHH”, a person shrieked as they put in too much liquid and now had to restart. The tables were shaking and as a person turned the corner, the blue string of their blue and purple hoodie caught on to a test tube. “CLASH CLACK CLACK CLACK”, as the clear test tube shattered into thousands of little shards of class. Sharp shards that would end someone up in the hospital if they are not carful. Of course, no one stop and help the now miserable group clean up their devastating mess, no, because of course every person had to hurry up and finish their precise measurements in the middle of all the catastrophic havoc that surrounded them all. While many groups were close to finishing, one must not forget the colossal amount of clean up each group had to do before they could exit the room. With only seconds left before one’s next class, one needed to hurry and dry all of the spilled liquids on each table. Every test tube one had to dry took an eternity, and it seemed as though there were millions of test tubes left to dry. After all the struggle of painfully drying every single test tube, one by one, one was finally done. One could now exit the room and onward to the next class. As one is packing up, one would see the intense burden on each person’s face, and one would smile to one’s self, “Good job me” one muttered."
  }
];
